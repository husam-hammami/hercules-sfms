...
export function Dashboard() {
    ...
    },
    {
      ...
      data: {
        ...
        datasets: [{
          data: [45, 35, 15, 5],
          backgroundColor: [
            'rgba(34, 197, 94, 0.9)',   // Excellent - Bright Green
            'rgba(59, 130, 246, 0.9)',  // Good - Professional Blue
            'rgba(245, 158, 11, 0.9)',  // Fair - Warning Orange
            'rgba(239, 68, 68, 0.9)'    // Poor - Alert Red
          ],
          borderColor: [
            'rgb(34, 197, 94)',         // Excellent - Bright Green
            'rgb(59, 130, 246)',        // Good - Professional Blue  
            'rgb(245, 158, 11)',        // Fair - Warning Orange
            'rgb(239, 68, 68)'          // Poor - Alert Red
          ],
          hoverBackgroundColor: [
            'rgba(34, 197, 94, 0.9)',   // Maintain green on hover
            'rgba(59, 130, 246, 0.9)',  // Maintain blue on hover
            'rgba(245, 158, 11, 0.9)',  // Maintain orange on hover
            'rgba(239, 68, 68, 0.9)'    // Maintain red on hover
          ],
          hoverBorderColor: [
            'rgb(34, 197, 94)',         // Maintain green border on hover
            'rgb(59, 130, 246)',        // Maintain blue border on hover
            'rgb(245, 158, 11)',        // Maintain orange border on hover
            'rgb(239, 68, 68)'          // Maintain red border on hover
          ],
          borderWidth: 3,
          hoverBorderWidth: 4
        }]
  ...
  useEffect(() => {
    const savedLayout = localStorage.getItem('fakieh-dashboard-charts')
    if (savedLayout) {
      try {
  ...
  useEffect(() => {
    localStorage.setItem('fakieh-dashboard-charts', JSON.stringify(chartItems))
  }, [chartItems])
  ...
  const resetLayout = () => {
    localStorage.removeItem('fakieh-dashboard-charts')
    window.location.reload()
  }

  return (
    <WaterSystemLayout 
      title="FSmart Factory Management System" 
