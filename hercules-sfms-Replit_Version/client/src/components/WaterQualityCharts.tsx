...
// Real-time water quality trend chart
...
export function WaterQualityCharts() {
  ...
  return (
    <>
      {/* Water Quality Monitoring - Top Left */}
      <div className="absolute top-4 left-3 z-20 bg-slate-800/95 backdrop-blur-sm rounded-xl p-3 border border-blue-500/30 w-64">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h3 className="text-blue-400 text-sm font-semibold">Water Quality Trends</h3>
        </div>
        ...
        <div className="space-y-3">
          <div className="bg-slate-800/50 rounded-lg p-2">
            ...
            <WaterQualityTrend data={phData} color="#3b82f6" width={220} height={35} />
          </div>
          ...
          <div className="bg-slate-800/50 rounded-lg p-2">
            ...
            <WaterQualityTrend data={turbidityData} color="#10b981" width={220} height={35} />
          </div>
        </div>
      </div>
